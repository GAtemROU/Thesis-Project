...
sink(file = "analysis/regressions/Bayesian/per_trial/results/toggling_rate_critical_strtg.txt")
...
saveRDS(regression, file = paste0("analysis/regressions/Bayesian/per_trial/trained_models/tog_rate_strtg.rds"))

saved_regr = readRDS(file = "/home/gatemrou/uds/thesis/Thesis-Project/analysis/regressions/Bayesian/per_trial/trained_models/tog_rate_strtg.rds")
